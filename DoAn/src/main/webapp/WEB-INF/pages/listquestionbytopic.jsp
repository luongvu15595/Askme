...
<body class="w3-theme-l5" ng-app="Askme" ng-controller="listquestionbytopicController" ng-init= "getQuestionByTopicData(${topic.id})">
...
<div class="w3-container w3-content" style="max-width:2000px;margin-top:80px">
    ...
    <div class="w3-row">
        ...
        <div class="w3-col m8">
            ...
            <div class="w3-container w3-card-2 w3-white w3-round w3-margin" dir-paginate="question in questionbytopics|itemsPerPage:8"><br>
                <div class="w3-col m3 ">
                    <div>
                        <span class="li">{{countanswerquestionbytopics[question.id_question]}}</span>
                        <span class="li">{{countvoteupquestionbytopicdatas[question.id_question]}}</span>
                    </div>
                    <div >
                ...
                <div class="w3-col m9">
                    ...
                    <div>
                        ...
                        <label ng-repeat="i in topics2[question.id_question]" class="q-tag">
