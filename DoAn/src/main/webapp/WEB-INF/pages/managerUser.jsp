...
<body ng-app="Askme" ng-controller="managerUser">
...
<div class="container">
    ...
    <table class="table table-bordered width">
        ...
        <tr  dir-paginate="user in users|filter:search |itemsPerPage:5">
            ...
            <td>{{user.email}}</td>
            <td>
                <button type="button" class="btn btn-danger" ng-click="delUserModal(user)" data-toggle="modal" data-target="#delModalQuestion">
                    Xoa
                </button></td>
