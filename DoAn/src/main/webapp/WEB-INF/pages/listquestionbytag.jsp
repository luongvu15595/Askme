...
<body class="w3-theme-l5" ng-app="Askme" ng-controller="listquestionbytagController" ng-init= "getQuestionByTagData(${tag.id})">
...
<div class="w3-container w3-content" style="max-width:2000px;margin-top:80px">
    ...
    <div class="w3-row">
        ...
        <div class="w3-col m8">
                ...
                <div class="w3-col m12">
                    <div class="w3-card-2 w3-round w3-white">
                        <div class="w3-container w3-padding">
                            <div class="w3-col m12 col-xs-6 "><label class="w3-col m9 labletag" >${tag.name}</label>
                                <form class="form-inline w3-col m3 inputtag top1">
                                    <input type="text" ng-model="search" class="form-control" placeholder="Tìm kiếm câu hỏi">
                                </form>
                            </div>
                        </div>
                    </div>
            ...
            <div class="w3-container w3-card-2 w3-white w3-round w3-margin" dir-paginate="question in questionbytags|filter:search|itemsPerPage:8"><br>

                <div class="w3-col m3 ">
                    <div>
                        <span class="li">{{countanswerquestionbytags[question.id_question]}}</span>
                        <span class="li">{{countvoteupquestionbytagdatas[question.id_question]}}</span>
                    </div>
                    <div >
                ...
                <div class="w3-col m9">
                    ...
                    <div>
                        ...
                        <label ng-repeat="i in tags2[question.id_question]" class="q-tag">
